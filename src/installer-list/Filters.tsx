...
type SetFiltersFunc = (
  setFiltersFunc: (oldFilters: InstallerFilters) => InstallerFilters,
) => void;
...
export function CodeFilter({ setFilters }: FilterProps) {
  return <TextFilter setFilters={setFilters} filterKey={"code"} />;
}
...
export function IsActiveFilter({ setFilters }: { setFilters: SetFiltersFunc }) {
  return (
